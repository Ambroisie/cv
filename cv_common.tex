...
\aboutme{%
  \enfr{%
    Currently a fifth year student at EPITA, I am looking for an end-of-studies
    internship abroad.
  }{%
    Actuellement étudiant de cinquième année à EPITA, je suis à la recherche
...
\enfr{%
  ...
  interest.  I am also fond of mathematics, physics, and science in a broader
  sense.
  ...
  \twentyitemshort{}
    {%
      \enfr{%
          ...
          Now migrated to a declarative confiuration using NixOS.
        }{%
          Hébergement de services divers sur un VPS à l'aide de Docker.
          Depuis migré vers NixOS afin d'avoir une configuration déclarative.
        }
    }
